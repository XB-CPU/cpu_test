...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = PS_to_CPU_controller_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXI_LCD_TOU_DRI
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = AXI_LCD_TOU_DRI_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_wr_bram
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_wr_rom
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_wr_bram
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_wr_bram_0
END
