...
`timescale 1 ns / 1 ps
	...
	module AXI_LCD_TOU_DRI_v1_0 #
	(
		// Users to add parameters here
		parameter DATA_WEDTH = 32,
	...
	(
		...
		input wire [DATA_WEDTH - 1 : 0] data_in,
		output wire  [PORT_NUM - 1 : 0] out_con_wout,
		// User ports ends
...
// Instantiation of Axi Bus Interface S0_AXI
	AXI_LCD_TOU_DRI_v1_0_S0_AXI # ( 
		.DATA_WEDTH(DATA_WEDTH),
		.PORT_NUM(PORT_NUM),
		.C_S_AXI_DATA_WIDTH(C_S0_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S0_AXI_ADDR_WIDTH)
	) AXI_LCD_TOU_DRI_v1_0_S0_AXI_inst (
		.data_in(data_in),
