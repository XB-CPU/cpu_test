...
HD_PWD='E:/Xilinx/FPGA_Prjs/dzy/cpu_test/cpu_test/cpu_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_test_wrapper.tcl -notrace
