...
HD_PWD='E:/Xilinx/FPGA_Prjs/dzy/cpu_test/cpu_test/cpu_test.runs/cpu_test_PS_to_CPU_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_test_PS_to_CPU_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_test_PS_to_CPU_controller_0_0.tcl
