...
#
# Script generated by Vivado on Wed Jan 03 20:00:17 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bluex_v_2_1.sh
...
#
# Usage        : bluex_v_2_1.sh
#                bluex_v_2_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bluex_v_2_1.sh [-reset_run]
#                bluex_v_2_1.sh [-reset_log]
#                bluex_v_2_1.sh [-help]
#
...
# script info
echo -e "bluex_v_2_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bluex_v_2_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bluex_v_2_1 xil_defaultlib.bluex_v_2_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bluex_v_2_1 -key {Behavioral:sim_1:Functional:bluex_v_2_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bluex_v_2_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Softwares/XILINX/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bluex_v_2_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bluex_v_2_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bluex_v_2_1.sh [-help]\n\
Usage: bluex_v_2_1.sh [-step]\n\
Usage: bluex_v_2_1.sh [-lib_map_path]\n\
Usage: bluex_v_2_1.sh [-reset_run]\n\
Usage: bluex_v_2_1.sh [-reset_log]\n\
Usage: bluex_v_2_1.sh [-keep_index]\n\
Usage: bluex_v_2_1.sh [-noclean_files]\n\n\
