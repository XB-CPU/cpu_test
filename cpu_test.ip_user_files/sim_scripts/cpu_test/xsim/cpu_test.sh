...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 floating_point_v7_0_21 xbip_dsp48_mult_v3_0_7 xbip_dsp48_multadd_v3_0_7 div_gen_v5_1_20)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cpu_test.wdb xsim.dir libdpi.so)
