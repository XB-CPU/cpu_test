...
entity cpu_test_axi_wr_bram_0_2_axi_wr_bram_v1_0_S0_AXI is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cpu_test_axi_wr_bram_0_2_axi_wr_bram_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    Q : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
begin
axi_wr_bram_v1_0_S0_AXI_inst: entity work.cpu_test_axi_wr_bram_0_2_axi_wr_bram_v1_0_S0_AXI
     port map (
      Q(1 downto 0) => Q(1 downto 0),
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cpu_test_axi_wr_bram_0_2 is
  port (
  ...
  attribute X_CORE_INFO of cpu_test_axi_wr_bram_0_2 : entity is "axi_wr_bram_v1_0,Vivado 2023.2";
end cpu_test_axi_wr_bram_0_2;

architecture STRUCTURE of cpu_test_axi_wr_bram_0_2 is
...
inst: entity work.cpu_test_axi_wr_bram_0_2_axi_wr_bram_v1_0
     port map (
      Q(1) => bram_we,
      Q(0) => bram_en,
