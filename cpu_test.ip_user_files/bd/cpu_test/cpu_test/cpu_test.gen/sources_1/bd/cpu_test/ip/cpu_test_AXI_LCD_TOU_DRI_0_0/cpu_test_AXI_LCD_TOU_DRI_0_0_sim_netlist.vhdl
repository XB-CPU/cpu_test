...
-- Date        : Fri Jan  5 20:55:39 2024
-- Host        : xyh running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/Xilinx/FPGA_Prjs/dzy/cpu_test/cpu_test/cpu_test.gen/sources_1/bd/cpu_test/ip/cpu_test_AXI_LCD_TOU_DRI_0_0/cpu_test_AXI_LCD_TOU_DRI_0_0_sim_netlist.vhdl
...
entity cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0_S0_AXI is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    out_con_wout : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME of cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0_S0_AXI : entity is "AXI_LCD_TOU_DRI_v1_0_S0_AXI";
end cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0_S0_AXI;

architecture STRUCTURE of cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0_S0_AXI is
  ...
  signal \^out_con_wout\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \slv_reg1[0]_i_3\ : label is "soft_lutpair1";
begin
  S_AXI_ARREADY <= \^s_axi_arready\;
  S_AXI_AWREADY <= \^s_axi_awready\;
  S_AXI_WREADY <= \^s_axi_wready\;
  out_con_wout(0) <= \^out_con_wout\(0);
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    out_con_wout : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0 : entity is "AXI_LCD_TOU_DRI_v1_0";
end cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0;

architecture STRUCTURE of cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0 is
begin
AXI_LCD_TOU_DRI_v1_0_S0_AXI_inst: entity work.cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0_S0_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cpu_test_AXI_LCD_TOU_DRI_0_0 is
  port (
    data_in : in STD_LOGIC_VECTOR ( 31 downto 0 );
    out_con_wout : out STD_LOGIC_VECTOR ( 0 to 0 );
    s0_axi_aclk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of cpu_test_AXI_LCD_TOU_DRI_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of cpu_test_AXI_LCD_TOU_DRI_0_0 : entity is "cpu_test_AXI_LCD_TOU_DRI_0_0,AXI_LCD_TOU_DRI_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of cpu_test_AXI_LCD_TOU_DRI_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of cpu_test_AXI_LCD_TOU_DRI_0_0 : entity is "AXI_LCD_TOU_DRI_v1_0,Vivado 2023.2";
end cpu_test_AXI_LCD_TOU_DRI_0_0;

architecture STRUCTURE of cpu_test_AXI_LCD_TOU_DRI_0_0 is
  signal \<const0>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of s0_axi_aclk : signal is "xilinx.com:signal:clock:1.0 S0_AXI_CLK CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of s0_axi_aclk : signal is "XIL_INTERFACENAME S0_AXI_CLK, ASSOCIATED_BUSIF S0_AXI, ASSOCIATED_RESET s0_axi_aresetn, FREQ_HZ 72000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN cpu_test_processing_system7_0_0_FCLK_CLK1, INSERT_VIP 0";
...
inst: entity work.cpu_test_AXI_LCD_TOU_DRI_0_0_AXI_LCD_TOU_DRI_v1_0
     port map (
